...
[![Version](https://img.shields.io/badge/version-0.1.0-green.svg)](library.json)
...
|---|---|---|
| `ByByte::MotorController` | [docs/api/motor-controller.md](docs/api/motor-controller.md) | Abstract brushed dual-motor backend (DRV8833 / TB6612). |
...
- `examples/bluetooth/` — `Basic`, `CarControl` Bluetooth sketches
...
- `examples/platformio_basic/` — PlatformIO starter
